...
Deschide `index.html` în browser. Atât. Pentru a o pune online gratuit:
- GitHub Pages (ex: pe un subdomeniu `app.sowilo.ro` sau domeniu separat `devizrapid.ro`), sau
- Netlify / Cloudflare Pages (drag & drop folderul) — gratis.
